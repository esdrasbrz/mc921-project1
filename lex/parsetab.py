...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','calculator_example.py',61),
  ('statement -> expression','statement',1,'p_statement_expr','calculator_example.py',65),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','calculator_example.py',69),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','calculator_example.py',70),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','calculator_example.py',71),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','calculator_example.py',72),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','calculator_example.py',79),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','calculator_example.py',83),
  ('expression -> NUMBER','expression',1,'p_expression_number','calculator_example.py',87),
  ('expression -> NAME','expression',1,'p_expression_name','calculator_example.py',91),
]
